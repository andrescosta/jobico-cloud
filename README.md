...
- [pgAdmin](https://www.pgadmin.org/): Feature rich administration and development platform for PostgreSQL. pgAdmin is accessible here: [https://pg.jobico.local/](https://pg.jobico.local/)
- [ZITADEL](https://github.com/zitadel/zitadel): Identity management service that implements several standards like OpenID Connect and SAML. The dashboard is accessible here: [https://id.jobico.local/](https://id.jobico.local/)
